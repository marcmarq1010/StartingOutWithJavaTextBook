...
public class CellPhone612
{
	...
	/** Constructor
		@param man The phone's manufacturer. @param mod The phone's model number. @param price The phone's retail price.
	*/
	
	public CellPhone612(String man, String mod, double price)
	{
		manufact = man; model = mod; retailPrice = price;
	}
